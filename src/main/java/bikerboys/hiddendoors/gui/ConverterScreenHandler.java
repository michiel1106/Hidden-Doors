...
public class ConverterScreenHandler extends ScreenHandler {
    ...
    public ConverterScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public ConverterScreenHandler(int syncId, PlayerInventory playerInventory, final ScreenHandlerContext context) {
        super(HiddenDoors.CONVERTER_SCREEN_HANDLER, syncId);
        ...
        this.input = new SimpleInventory(1) {
            public void markDirty() {
                ...
                ConverterScreenHandler.this.contentsChangedListener.run();
            }
        };
        ...
        this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                ConverterScreenHandler.this.output.unlockLastRecipe(player, this.getInputStacks());
                ItemStack itemStack = ConverterScreenHandler.this.inputSlot.takeStack(1);
                if (!itemStack.isEmpty()) {
                    ConverterScreenHandler.this.populateResult();
                }

                context.run((world, pos) -> {
                    long l = world.getTime();
                    if (ConverterScreenHandler.this.lastTakeTime != l) {
                        world.playSound((PlayerEntity)null, pos, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundCategory.BLOCKS, 1.0F, 1.0F);
                        ConverterScreenHandler.this.lastTakeTime = l;
                    }
            ...
            private List<ItemStack> getInputStacks() {
                return List.of(ConverterScreenHandler.this.inputSlot.getStack());
            }
        });
    ...
    void populateResult() {
        if (!this.availableRecipes.isEmpty() && this.isInBounds(this.selectedRecipe.get())) {
            ...
            ItemStack itemStack = ((StonecuttingRecipe)recipeEntry.value()).craft(createRecipeInput(this.input), this.world.getRegistryManager());
    ...
    public ScreenHandlerType<?> getType() {
        return HiddenDoors.CONVERTER_SCREEN_HANDLER;
    }
